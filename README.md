...
data-mocker-cli/0.3.1 linux-x64 node-v12.18.1
$ dmcli --help [COMMAND]
USAGE
  $ dmcli COMMAND
...
...
_See code: [src/commands/generate.ts](https://github.com/Gunmer/data-mocker-cli/blob/v0.3.1/src/commands/generate.ts)_
